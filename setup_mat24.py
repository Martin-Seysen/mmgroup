...
from dev.config import EXTRA_COMPILE_ARGS
...
#
custom_presteps = [
  [sys.executable, os.path.join(DEV_DIR, "mat24", "codegen.py")],
  [sys.executable, os.path.join(DEV_DIR, "mat24", "make_mat24_dll.py")],
  [sys.executable, os.path.join(DEV_DIR, "mat24_xi", "codegen.py")],
]


build_ext_delete = [
    os.path.join(DEV_DIR, "mat24", "mat24fast.c"),
    os.path.join(DEV_DIR, "mat24", "*.o"),
    #os.path.join(DEV_DIR, "mat24", "mat24_functions.pxd"),
    os.path.join(DEV_DIR, "mat24", "mat24*.def"),
    os.path.join(DEV_DIR, "mat24_xi", "mat24_xi.c"),
    os.path.join(DEV_DIR, "mat24_xi", "*.o"),
    os.path.join(DEV_DIR, "mat24_xi", "mat24*.def"),
]
...
class GenCodeCommand(setuptools.Command):
    ...
    """
    custom_presteps = custom_presteps # list of presteps
    ...
    def run(self):
        for prestep_command in self.custom_presteps:
...
class  BuildExtCommand(build_ext):
    ...
    """
    build_ext_delete = build_ext_delete
    ...
    def custom_delete_intermediate_files(self):
        for file_pattern in self.build_ext_delete:
