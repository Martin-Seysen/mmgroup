...
from mmgroup.clifford12 import xsp2co1_rand_word_N_x0
...
class MMGroup(AbstractGroup):
    ...
    def rand_N_x0(self, in_N_x0 = False, even = False, seed = None):
        ...
        The function returns a uniform distributed random element
        of the subgroup :math:`N_{x0}` of the monster of structure
