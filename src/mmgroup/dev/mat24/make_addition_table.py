...
class BitMatrixAddChain(object):
    ...
    def __init__(self, fixed_matrix, granularity = 4):
    ...
    def selftest(self):
        """test matrix multiplcation fixed_matrix *  unit_matrix
...
def generate_c_bitmatmul(table, type, input_var, output_var): 
    bm = BitMatrixAddChain(table)
    bm.set_names(type, input_var, output_var)
    bm.selftest()
    return bm.make_c_program()
