...
of structure :math:`2^{1+24}_+.\mbox{O}_{24}(2)`. In this section we
introduce a fast algorithm for computing in :math:`\mathcal{C}_{12}` 
and also in its complex analogue :math:`\mathcal{X}_{12}` 
of structure :math:`\frac{1}{2} ( 2^{1+24}_+ \times Z_8 ).
\mbox{Sp}_{24}(2)`, defined in :cite:`NRS01`. Here a factor 
