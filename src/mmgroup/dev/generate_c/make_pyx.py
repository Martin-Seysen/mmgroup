...
def pxd_to_pyx(pxd_file, module = None, translate = None, doc = None): 
    ...
    <module> is constructed from the name 'pxd_file' of the .pxd file.
    ...
    <return_type> and <type1>, <type2>, ... must be valid types known
    to Cython and C. The types  <type1>, <type2> used for arguments may
    also be pointers. Then pointers are converted to memory views e.g:
    ...
    The <return_type> may be void, but not be a pointer. Other types 
    are not allowed.
