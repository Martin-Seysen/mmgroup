...
from mmgroup.dev.mm_basics.mm_basics import MM_Op, smask, c_hex, INT_BITS
...
class HadamardMatrixCode(MM_Op):
    ...
    def make_h_masks(self):
        ...
        self.B1_MASK = {} 
        self.H_MASK = {} 
        mask = smask(self.P, -1, self.FIELD_BITS << self.NO_CARRY) 
        self.H_MASK_EXTERN = mask
        mask = smask(self.P + 1, -1, self.FIELD_BITS << self.NO_CARRY) 
