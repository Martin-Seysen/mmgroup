...
an one-dimensional array of integers of type ``uint_mmv_t``. Here
...
for readablity and not for speed. Here a typical task is to read
...
On input, entries with sevaral equal tuples ``(tag, i0, i1)`` are 
