...
// This table may be deprecated in the future!!!
// %%EXPORT_TABLE
const uint_mmv_t MM_SUB_INV_2048_TABLE[] = { 
// %%TABLE MM_INV_2048_TABLE, uint32
0x00000000UL,0x3cc3c33cUL,0x3cc3c33cUL,0x3cc3c33cUL,
0xf00f0ff0UL,0xcc3333ccUL,0xc3c33c3cUL,0xc33cc33cUL,
0xf00f0ff0UL,0xc33cc33cUL,0xcc3333ccUL,0xc3c33c3cUL,
0xf00f0ff0UL,0xc3c33c3cUL,0xc33cc33cUL,0xcc3333ccUL,
0xccccccccUL,0xf0f0f0f0UL,0xffff0000UL,0xff00ff00UL,
0x3c3c3c3cUL,0x00ffff00UL,0xffffffffUL,0xffffffffUL,
0x33cc33ccUL,0xffffffffUL,0xffffffffUL,0x0f0ff0f0UL,
0x3333ccccUL,0xffffffffUL,0x0ff00ff0UL,0xffffffffUL,
0xccccccccUL,0xff00ff00UL,0xf0f0f0f0UL,0xffff0000UL,
0x3333ccccUL,0xffffffffUL,0xffffffffUL,0x0ff00ff0UL,
0x3c3c3c3cUL,0xffffffffUL,0x00ffff00UL,0xffffffffUL,
0x33cc33ccUL,0x0f0ff0f0UL,0xffffffffUL,0xffffffffUL,
0xccccccccUL,0xffff0000UL,0xff00ff00UL,0xf0f0f0f0UL,
0x33cc33ccUL,0xffffffffUL,0x0f0ff0f0UL,0xffffffffUL,
0x3333ccccUL,0x0ff00ff0UL,0xffffffffUL,0xffffffffUL,
0x3c3c3c3cUL,0xffffffffUL,0xffffffffUL,0x00ffff00UL
};
...
// operation.
{
    ...
    // Prepare permutation of the 3 * 24 rows of 24 entries for tags A, B, C
    {
        ...
        for (i = 0; i < 24; ++i) {
            ...
            p_24big[i + 2048 + 48] = (t + 48) | ((delta & 1) << 15);  
        }
    }
...
#define PwrMap(d) ((MAT24_THETA_TABLE[((d) >> 1) & 0x7ff] >> 12) & 1)
...
// operation.
{
    ...
    {
        uint_fast16_t e1 = (e & 0xfff) >> 1;
        uint_fast16_t ef1 = ((e ^ f) & 0xfff) >> 1;
        uint_fast16_t eps1 = ((eps & 1) ^ 1) << 12; 
        uint_fast8_t *p_XYZ = p_op->sign_XYZ;
        uint_fast16_t d;
