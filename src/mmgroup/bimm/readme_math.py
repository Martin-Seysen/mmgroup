...
automorphism group of :math:`\mbox{P3}`.
...
In this section we construct a mapping :math:`\Phi` from the Coxeter
group  :math:`\,\mbox{IncP3} : \mbox{AutP3} \,` to the Bimonster using 
the mapping :math:`\phi : \mbox{IncP3}^+ : \mbox{AutP3} \rightarrow \mathbb{M}` 
defined in the last subsection. 

The generator :math:`\alpha` in :math:`\mbox{IncP3} \setminus \mbox{IncP3}^+`
...
precisely the elements of shape :math:`(m, m^{-1}) \cdot \alpha`,
:math:`m \in \mathbb{M}`.
