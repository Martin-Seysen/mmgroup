...
ERR_ATOM = "Illegal atom %s in constructor of class MGroupNWord"
...
class MGroupN(AutoGroup):
    r"""Models the subgroup N_0 of the Monster MM or one of its covers.

    We may also support a specific generator l of order 3 of MM \ N_0 
    ...
    operations of MM on its 196884-dimensional representation.
    """
    ...
    group_name = "MN"
    #kernel = 0  # for compatibility with older version
