...
``generate_c.TableGeneratorStream``. There .c and .h files are generated
...
of class  ``TableGeneratorStream`` is created. A table generator ``tg`` 
...
instance ``tg`` of class  ``TableGeneratorStream`` described above. 
